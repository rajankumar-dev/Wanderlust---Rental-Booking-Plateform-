      ...
      >
        ...
        <div className="w-[90%] flex items-start justify-start flex-col gap-[10px]">
          ...
          <input
            type="email"
            id="email"
            className="w-[90%] h-[40px] border-[2px] border-[#555656] rounded-lg text-[18px] px-[15px]"
          />
        </div>
        <div className="w-[90%] flex items-start justify-start flex-col gap-[10px] relative">
          ...
          {!show && (
            <IoMdEye
              className="w-[22px] h-[22px] absolute cursor-pointer right-[12%] bottom-[10px]"
        ...
        <button className="px-[50px] py-[10px] bg-[red] text-[#fff] rounded-lg text-[18px] mt-[15px]">
          Login
        </button>
